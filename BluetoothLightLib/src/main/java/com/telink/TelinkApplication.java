...
public class TelinkApplication extends Application {
    ...
    protected void onNotify(Intent intent) {
        ...
        Log.e("onNotify", Arrays.bytesToHexString(notifyInfo.params, ","));
        if (onDeviceNotifyData != null)
            onDeviceNotifyData.onNotifyData(notifyInfo.opcode, notifyInfo.src, notifyInfo.params, notifyInfo.deviceInfo);
        this.onNotify(notifyInfo);
    }

    public interface onDeviceNotifyData {
        void onNotifyData(int opcode, int src, byte[] params, DeviceInfo deviceInfo);
    }

    private onDeviceNotifyData onDeviceNotifyData;

    public void setOnDeviceNotifyData(TelinkApplication.onDeviceNotifyData onDeviceNotifyData) {
        this.onDeviceNotifyData = onDeviceNotifyData;
    }
